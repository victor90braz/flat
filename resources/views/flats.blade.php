...
<body>
    ...
    <div class="bg-white">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900">All Flats</h2>

        <div class=" flex mx-auto max-w-2xl border-1-black py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-2">
